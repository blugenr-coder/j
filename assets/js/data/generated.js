...
const PLAN = {
  ...
  placevalue:  ['Grade 1', 'Grade 6', [
    ['Value of a Digit', [0, 8, 13]], ['Expanded Form', [1, 2, 11]],
    ['More and Less', [3, 4, 9]], ['Comparing and Ordering', [5, 6, 12], 'Grade 2'],
    ['Multiplying by 10 and 100', [7, 8, 10], 'Grade 3'],
    ['Building Numbers From Digits', [11, 12], 'Grade 2'],
    ['Decimal Place Value', [13, 0], 'Grade 4'], 'Mixed Practice']],
  addition:    ['Pre-K', 'Grade 5', [
    ['Number Bonds to 20', [0, 2, 6]], ['Adding Two-Digit Numbers', [1, 8, 15], 'Grade 1'],
    ['Column Addition', [3, 5], 'Grade 2'], ['Adding Three Numbers', [4, 12, 14], 'Grade 1'],
    ['Missing Numbers', [6, 7, 11], 'Grade 1'], ['Adding Large Numbers', [5, 9, 15], 'Grade 4'],
    ['Doubles and Near Doubles', [13, 4], 'Grade 1'],
    ['Number Bonds to 100', [11, 6], 'Grade 2'],
    ['Word Problems', [10, 15], 'Grade 1'], 'Mixed Practice']],
  subtraction: ['Pre-K', 'Grade 5', [
    ['Subtracting Within 20', [0, 1]], ['Two-Digit Subtraction', [2, 8, 13], 'Grade 1'],
    ['Column Subtraction', [3, 5], 'Grade 2'], ['Subtracting Across Zero', [4, 15], 'Grade 3'],
    ['Missing Numbers', [6, 7, 11], 'Grade 1'], ['Subtracting Large Numbers', [5, 9], 'Grade 4'],
    ['Finding the Difference', [14, 13], 'Grade 2'],
    ['Counting Back to 100', [11, 15], 'Grade 2'],
    ['Word Problems', [10, 13], 'Grade 1'], 'Mixed Practice']],
  timestables: ['Grade 1', 'Grade 6', [
    ['Tables to 10', [0, 1, 7, 10]], ['Tables to 12', [2, 3, 15], 'Grade 2'],
    ['Dividing by a Table Fact', [4, 14], 'Grade 2'], ['Missing Factors', [5, 6, 14], 'Grade 2'],
    ['Multiplying Three Numbers', [8, 0], 'Grade 3'], ['Multiples of Ten', [9, 1], 'Grade 2'],
    ['Counting in Steps', [13, 11], 'Grade 1'],
    ['Word Problems', [12, 11], 'Grade 2'], 'Mixed Practice']],
  multiplication: ['Grade 2', 'Grade 8', [
    ['Short Multiplication', [0, 2, 8]], ['Long Multiplication', [1, 5, 14], 'Grade 4'],
    ['Multiplying by 10, 100 and 1000', [3, 4]], ['Multiplying Three Numbers', [6, 15], 'Grade 3'],
    ['Missing Factors', [7, 0], 'Grade 3'], ['Squaring', [9, 0], 'Grade 5'],
    ['Doubling and Halving Tricks', [11, 12], 'Grade 3'],
    ['Arrays and Area', [10, 13], 'Grade 3'], 'Mixed Practice']],
  division:    ['Grade 2', 'Grade 8', [
    ...
    ['Missing Numbers', [6, 7], 'Grade 3'], ['Halving and Quartering', [8, 11]],
    ['Grouping', [12, 13], 'Grade 3'],
    ['Sharing Problems', [10, 15], 'Grade 2'], 'Mixed Practice']],
  ...
  rounding:    ['Grade 2', 'Grade 10', [
    ['Rounding to 10, 100 and 1000', [0, 1, 2, 11]], ['Rounding Decimals', [3, 4, 5], 'Grade 4'],
    ['Significant Figures', [6, 7, 8], 'Grade 6'], ['Numbers Below One', [9, 3], 'Grade 7'],
    ['Rounding to the Nearest 5', [10, 0], 'Grade 2'],
    ['Estimating', [12, 13], 'Grade 4'], ['Rounding Money', [14, 5], 'Grade 3'],
    'Mixed Practice']],
  factors:     ['Grade 3', 'Grade 9', [
    ['Listing Factors', [0, 5, 6]], ['Highest Common Factor', [1, 9], 'Grade 5'],
    ['Lowest Common Multiple', [2, 7, 12], 'Grade 5'],
    ['Primes and Prime Factors', [3, 4, 13, 14], 'Grade 5'],
    ['Square Numbers', [8, 0], 'Grade 4'],
    ['Multiples', [10, 11, 7], 'Grade 3'], 'Mixed Practice']],
  ...
  percentops:  ['Grade 4', 'Grade 11', [
    ['Percentages of Amounts', [0, 1]], ['Increase and Decrease', [2, 3, 15], 'Grade 6'],
    ['Percentages, Decimals and Fractions', [4, 5, 6, 7]],
    ['One Number as a Percentage of Another', [8, 12], 'Grade 6'],
    ['Reverse Percentages', [9, 11, 14], 'Grade 8'], ['Percentages of Money', [10, 15], 'Grade 5'],
    ['Test Scores as Percentages', [12, 8], 'Grade 5'],
    ['Simple Interest', [13, 10], 'Grade 8'], 'Mixed Practice']],
  ratio:       ['Grade 5', 'Grade 11', [
    ['Simplifying Ratios', [0, 1, 7, 13]], ['Sharing in a Ratio', [2, 3, 8]],
    ['Equivalent Ratios', [4, 5, 12]], ['Ratio and Fractions', [6, 12], 'Grade 6'],
    ['Scaling Up a Recipe', [9, 14]],
    ['Direct Proportion', [10, 14], 'Grade 6'], ['Map Scales', [11, 13], 'Grade 6'],
    'Mixed Practice']],
  ...
  sequences:   ['Grade 3', 'Grade 11', [
    ['Continuing a Sequence', [0, 1, 5, 11]], ['The Term-to-Term Rule', [4, 9, 10]],
    ['The nth Term', [2, 3, 8, 13], 'Grade 6'],
    ['Geometric and Square Sequences', [6, 7, 12], 'Grade 5'],
    ['Falling Sequences', [1, 14], 'Grade 6'], 'Mixed Practice']],
  standardform:['Grade 8', 'College', [
    ['Writing Standard Form', [0, 1, 8, 10]], ['Back to Ordinary Numbers', [2, 3, 6, 13]],
    ['Multiplying and Dividing', [4, 5, 11]], ['Adding and Subtracting', [7, 12]],
    ['Powers of Ten', [6, 13, 9]], 'Mixed Practice']],
  ...
  conversions: ['Grade 2', 'Grade 9', [
    ['Length', [0, 1, 2, 5, 8, 12]], ['Mass', [3, 6, 11]], ['Capacity', [4, 7]],
    ['Units of Time', [9, 10, 13, 14]], ['Small Units to Large', [5, 6, 7, 8, 12, 13], 'Grade 4'],
    ['Mixed Units', [15, 12], 'Grade 4'], 'Mixed Practice']],
